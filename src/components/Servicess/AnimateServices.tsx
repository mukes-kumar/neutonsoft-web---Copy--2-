...
function ServicesAnimate() {
  ...
  return (
    <>
      ...
      <div className='max-w-[1200px] mx-auto py-[0px] grid lg:grid-cols-4 sm:grid-cols-1 gap-6'>


        <div className="relative overflow-hidden bg-slate-400 p-20">
          <div className="absolute bottom-0 left-0 right-0 h-0 hover:bg-blue-500 transition-height duration-1000 ease-in-out group-hover:h-full group-hover:p-20">Hi</div>
        </div>
