...
const SingleFeature = ({ feature }: { feature: Feature }) => {
  ...
  return (
    <div className="group w-full shadow-sm p-2 transition-all ease-in-out delay-250  hover:-translate-y-1  hover:duration-300 hover:ease-linear rounded-md  z-10 
